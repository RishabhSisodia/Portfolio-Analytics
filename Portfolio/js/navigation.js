$(document).ready(function(){
 ...
 // if scroll is higher than 500px don't show "open to opportuinity"
$(document).ready(function(){
...
$(document).ready(function(){
 ...
 $(document).ready(function() {
	$(".animatelink").click(function(e) {
		if(e.target.classList.contains("contact-btn") || e.target.classList.contains("fa-paper-plane")) return;
		 e.preventDefault();
		 $link = $(this).attr("href");
